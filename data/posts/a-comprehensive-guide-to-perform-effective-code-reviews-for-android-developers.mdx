...
Code reviews are a part of most dev day-to-day work. Despite being a standard industry practice for many years, there are still lots of disagreements around how code reviews should be conducted. In this post, we’ll look at how our framework helps us get code reviews done efficiently.
...
![Photo on [Fork](https://git-fork.com/)](https://miro.medium.com/max/700/0*Ez-_mtsvjz5ymPh0.jpg)
...
. He writes his thoughts about Software Engineering and life in general on his [Twitter](https://twitter.com/eenriquelopez) account. And this is me on [Github](https://github.com/fastphat), I build and publish stuff there! You can also find me on [Twitter](https://twitter.com/phatnhse). If you have any questions for us, feel free to drop a message or leave a comment. Happy reading and remember to 👏 if you have liked the post so far.